  ...
  return (
    ...
    <section id="proyectos">
      ...
      <div className="proyecto">
        ...
        <a href="https://gorgeous-kitsune-01d52c.netlify.app/">miralo aqui</a>
      </div>
      <div className="proyecto">
        <h3>Music</h3>
        <p>Music es un proyecto el cual tiene una amplia gama de colores</p>
        <a href="https://chimerical-narwhal-b12221.netlify.app/">miralo aqui</a>
      </div>
    </section>
    ...
    <section id="contacto">
      <h2>Contacto</h2>
      <p>Puedes contactarme en: <a href="mailto:juanesteban@example.com" id="correo">juanestebanh390@gmail.com</a></p>
    </section>
  </main>
  )
}
